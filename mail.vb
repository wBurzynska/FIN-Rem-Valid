...
Sub MissInv(ByVal unusedRow As Long, ByVal CaseNo As Long)
    ...
    If Not IsError(matchIndex) Then
        ...
        sToEmail = emailColumn.Cells(matchIndex).Value
    
        Dim templateColumn As Range
        Set templateColumn = dataSheet.Range("E2:E" & dataSheet.Cells(dataSheet.Rows.Count, "E").End(xlUp).Row)
